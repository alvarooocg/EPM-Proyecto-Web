    ...
    <div className="min-h-screen w-full flex flex-col p-6 bg-gradient-to-b from-primary-container/20 to-background">
      ...
      <main className="flex-1 flex flex-col items-center justify-center max-w-4xl mx-auto w-full gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          ...
          <Link to="/mundo-tranquilo" state={{ transitionType: 'push' }} className="bg-surface-container glass-panel rounded-3xl p-6 border border-outline-variant/30 flex flex-col items-center text-center gap-4 bouncy-hover group">
