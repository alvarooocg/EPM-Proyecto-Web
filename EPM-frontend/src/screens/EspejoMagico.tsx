    ...
    <div className="min-h-screen w-full flex flex-col p-6 bg-surface relative overflow-hidden">
      <header className="w-full flex items-center justify-between mb-8 z-10 relative">
        ...
        <div className="flex gap-4">
          <Link to="/selector-emociones" state={{ transitionType: 'push' }} className="w-12 h-12 rounded-full bg-surface-container-high border border-outline-variant/50 flex items-center justify-center bouncy-hover text-on-surface hover:text-secondary">
            <span className="material-symbols-outlined">emoji_emotions</span>
          </Link>
          <Link to="/evolucion-planeta" state={{ transitionType: 'push' }} className="w-12 h-12 rounded-full bg-surface-container-high border border-outline-variant/50 flex items-center justify-center bouncy-hover text-on-surface hover:text-secondary">
      ...
      <main className="flex-1 flex flex-col items-center justify-center z-10 relative">
        ...
        <div className="w-72 h-96 bg-surface-container-low rounded-[40px] border-8 border-secondary-container relative flex items-center justify-center overflow-hidden">
           ...
           <div className="w-40 h-40 rounded-full border-4 border-dashed border-secondary/50 flex items-center justify-center">
             <span className="material-symbols-outlined text-6xl text-on-surface-variant">face</span>
           </div>
           
           {/* Magic sparkles */}
           <span className="material-symbols-outlined absolute top-6 right-6 text-tertiary animate-pulse">auto_awesome</span>
           <span className="material-symbols-outlined absolute bottom-12 left-6 text-tertiary animate-pulse" style={{ animationDelay: '0.5s' }}>auto_awesome</span>
        </div>
      ...
      <Link to="/relacion" state={{ transitionType: 'push_back' }} className="absolute bottom-8 left-8 flex flex-col items-center gap-1 opacity-50 hover:opacity-100 transition-opacity">
