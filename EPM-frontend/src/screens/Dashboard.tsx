...
export default function Dashboard() {
  return (
    <div className="min-h-screen w-full flex flex-col p-6 bg-surface">
      ...
      <main id="main-content" className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto w-full">
        {/* Left column - Charts */}
          ...
          <section className="bg-surface-container glass-panel rounded-3xl p-6 border border-outline-variant/30">
             ...
             <div className="flex justify-around items-center h-40">
                <div className="flex flex-col items-center">
                  ...
                  <span className="material-symbols-outlined text-tertiary mt-2" aria-hidden="true">sentiment_satisfied</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="text-3xl font-bold text-secondary">30%</div>
                  <span className="material-symbols-outlined text-secondary mt-2" aria-hidden="true">sentiment_neutral</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="text-3xl font-bold text-primary">25%</div>
                  <span className="material-symbols-outlined text-primary mt-2" aria-hidden="true">self_improvement</span>
                </div>
             </div>
          </section>
        </div>
        ...
        <div className="space-y-6">
           <section className="bg-surface-container glass-panel rounded-3xl p-6 border border-outline-variant/30">
            ...
            <ul className="space-y-4">
              <li className="flex items-center justify-between">
                <span className="flex items-center gap-2 text-secondary"><span className="material-symbols-outlined" aria-hidden="true">diversity_3</span> Relación</span>
                <span className="font-bold">12h</span>
              </li>
              <li className="flex items-center justify-between">
                <span className="flex items-center gap-2 text-primary"><span className="material-symbols-outlined" aria-hidden="true">self_improvement</span> Me Relajo</span>
          ...
          <section className="bg-surface-container-high rounded-3xl p-6 border border-outline-variant/30 flex flex-col items-center text-center">
            <span className="material-symbols-outlined text-5xl text-tertiary mb-2" aria-hidden="true">military_tech</span>
